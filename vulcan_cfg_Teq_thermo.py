...
atm_file = 'atm/atm_Teq_500_P_Kzz.txt' # TP and Kzz (optional) file
...
out_name =  'Teq_500_P.vul' # output file name
...
O_H = 0.0004897788193684457
P_H = 2.570395782768865e-07
...
P_t = 1e3 # pressure at the top (dyne/cm^2)
use_Kzz = True
use_moldiff = True
...
gs = 1000.         # surface gravity (cm/s^2)  (HD189:2140  HD209:936)
...
plot_spec = ['PH3','PH2','PH','HOPO','HOPO2','P2','P4','P','O','H','OH','H3PO4','P4O6']
# output:
