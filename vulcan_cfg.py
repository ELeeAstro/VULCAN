...
out_name =  'HD189_P_th_10x.vul' # output file name
...
# customized elemental abundance (only read when use_solar = False) # Elsie Uses Aslpund et al. (2021)
O_H = 4.897788193684457e-04 * 10.0
P_H = 2.570395782768865e-07 * 10.0
He_H = 0.08203515443298177
ini_mix = 'EQ' # Options: 'EQ', 'const_mix', 'vulcan_ini', 'table' (for 'vulcan_ini, the T-P grids have to be exactly the same)
fastchem_met_scale = 10.0 # scaling factor for other elements in fastchem (e.g., if fastchem_met_scale = 0.1, other elements such as Si and Mg will take 0.1 solar values)
...
#plot_spec = ['PH3','PH2','HOPO','HOPO2']
#plot_spec = ['PH3','PH2','PH','HOPO','HOPO2','P2H2','P2H3','P2H4','H3PO4','OH','O','P4O6']
plot_spec = ['PH3','PH2','PH','P','PO','PO2','HOPO','P2','P4','OH', 'P4O6']
#plot_spec = ['PH3','PH2','PO','PO2','HOPO','H3PO4']
# output:
